...
public class Main {
    public static void main(String[] args) {
        ...
        Product p2 = new Product("APPLE MacBook Pro 2024 16\"", 16000,"laptops", 100);
        Product p3 = new Product("JBL Tune 770NC ANC", 300,"headphones", 50);
        Product p4 = new Product("Acer Nitro 5 17,1\'", 5000,"laptops", 40);
